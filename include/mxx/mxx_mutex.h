...
class mutex {
  ...
  public:
    mutex()
    {
        c74::max::systhread_mutex_new(&m_mtx, c74::max::e_max_systhread_mutex_flags::SYSTHREAD_MUTEX_NORMAL);
    }
...
class recursive_mutex {
  ...
  public:
    recursive_mutex()
    {
        c74::max::systhread_mutex_new(&m_mtx, c74::max::e_max_systhread_mutex_flags::SYSTHREAD_MUTEX_RECURSIVE);
    }
